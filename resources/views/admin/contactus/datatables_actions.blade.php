...
<div class='btn-group'>
    ...
    <a title="View" href="{{ route('admin.contactus.show', $id) }}" class='btn btn-default btn-xs'>
        <i class="glyphicon glyphicon-eye-open"></i>
    </a>
    @endability
    @ability('super-admin' ,'contactus.edit')
    <a title="Edit" href="{{ route('admin.contactus.edit', $id) }}" class='btn btn-default btn-xs'>
