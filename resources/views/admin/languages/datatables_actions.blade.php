...
<div class='btn-group'>
    ...
    <a title="View" href="{{ route('admin.languages.show', $code) }}" class='btn btn-default btn-xs'>
        <i class="glyphicon glyphicon-eye-open"></i>
    </a>
    @endability
    @ability('super-admin' ,'languages.edit')
    <a title="Edit" href="{{ route('admin.languages.edit', $code) }}" class='btn btn-default btn-xs'>
