...
<div class='btn-group'>
    ...
    <a title="View" href="{{ route('admin.settings.show', $id) }}" class='btn btn-default btn-xs'>
        <i class="glyphicon glyphicon-eye-open"></i>
    </a>
    @endability
    @ability('super-admin' ,'settings.edit')
    <a title="Edit" href="{{ route('admin.settings.edit', $id) }}" class='btn btn-default btn-xs'>
