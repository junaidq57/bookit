...
<div class="form-group col-sm-6">
    ...
    {!! Form::number('salary', $user->details->salary?? null, ['class' => 'form-control']) !!}
</div>
    ...
    <div id="company" style="display: none">
        ...
        <div class="form-group col-sm-6">
            ...
            {!! Form::text('company', $user->company->company?? null, ['class' => 'form-control required']) !!}
        </div>

        <!-- Company Detail Field -->
        <div class="form-group col-sm-6">
            {!! Form::label('company_detail', 'Company Detail:') !!}
            {!! Form::text('detail', $user->company->detail?? null, ['class' => 'form-control required']) !!}
        </div>
    </div>
...
<!-- Image Field -->
<div class="form-group col-sm-3">
    <img src="{{ $user->details->ImageUrl??null }}" width="50">
</div>
