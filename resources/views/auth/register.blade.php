                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input id="role" type="radio" name="role" class="form-control{{ $errors->has('role') ? ' is-invalid' : '' }}" value="dispatcher">Dispatcher
                                <input id="role" type="radio" name="role" class="form-control{{ $errors->has('role') ? ' is-invalid' : '' }}" value="delivery_boy">Delivery Boy
                                @if ($errors->has('role'))
