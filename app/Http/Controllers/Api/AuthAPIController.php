...
use App\Helper\ImageCompare as ImageCompare;
...
class AuthAPIController extends AppBaseController
{
     ...
     */
    public function __construct(UserRepository $userRepo, UserDetailRepository $userDetailRepo, UDeviceRepository $uDeviceRepo, SocialAccountRepository $socialAccountRepo, UserDetail $userDetail)
    {
    ...
    public function login(LoginAPIRequest $request)
    {
        ...
        // if(!$this->faceRecognize($request)){
        //     return $this->sendErrorWithData([
        //         "loginFailed" => "Please contact Website admin, Thanks"
        //     ], 403, []);
        // }
    ...
    public function faceRecognize(LoginAPIRequest $request)
    {
        ...
        $imagePath = $user->details->image_url;
        ...
        if($imagePath)
        {
            ...
            $ratio = $image->compare($imageFile,$imagePath);
