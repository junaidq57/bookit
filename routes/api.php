...
Route::resource('v1/attendances', 'AttendanceAPIController');

Route::resource('v1/tasks', 'TaskAPIController');

Route::resource('v1/task-categories', 'TaskCategoryAPIController');

Route::resource('v1/task-comments', 'TaskCommentAPIController');

Route::resource('v1/orders', 'OrderAPIController');

Route::resource('v1/order-items', 'OrderItemAPIController');

Route::resource('v1/orderitems', 'OrderitemAPIController');

Route::resource('v1/quickorders', 'QuickorderAPIController');

Route::post('v1/quickorders/updatedata', 'QuickOrderAPIController@updateData');

Route::post('v1/quickorders/createpayment', 'FacilitatorTrackAPIController@payment');

Route::resource('v1/quickorderitems', 'QuickorderitemAPIController');

Route::resource('v1/facilitators', 'FacilitatorAPIController');

Route::resource('v1/facilitator-tracks', 'FacilitatorTrackAPIController');